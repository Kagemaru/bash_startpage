<script>
  ...
  const changelog = [
    ...
    { v: "1.7", f: "Command history (Up/Down arrow navigation)." }
  ];
    ...
    <div class="output-area">
      {#if showHelp}
        <div class="special-view">
          <div class="view-title">VIM-STYLE COMMANDS</div>
          {#each availableCommands as cmd}
            <div class="view-row"><span class="cmd">:{cmd}</span></div>
          {/each}
        </div>
...
<style>
  ...
  .theme-mocha {
    ...
    --term-rgb: 24, 24, 37;
    --text: #ffffff; --primary: #cba6f7; --secondary: #94e2d5; --accent: #f38ba8; --input-bg: rgba(49, 50, 68, 0.9); --dim: #bac2de; --glow: rgba(203, 166, 247, 0.2);
  }
  .theme-tokyo {
    --bg-img: linear-gradient(135deg, #1a1b26 0%, #16161e 100%);
    --term-rgb: 22, 22, 30;
    --text: #ffffff; --primary: #bb9af7; --secondary: #73daca; --accent: #f7768e; --input-bg: rgba(36, 40, 59, 0.9); --dim: #a9b1d6; --glow: rgba(187, 154, 247, 0.2);
  }
  .theme-matrix {
    --bg-img: #000;
    --term-rgb: 5, 5, 5;
    --text: #00ff41; --primary: #00ff41; --secondary: #00ff41; --accent: #fff; --input-bg: rgba(0, 0, 0, 0.9); --dim: #008f11; --glow: rgba(0, 255, 65, 0.2);
  }
  .theme-light {
    --bg-img: linear-gradient(135deg, #eff1f5 0%, #dce0e8 100%);
    --term-rgb: 230, 233, 239;
    --text: #4c4f69; --primary: #7287fd; --secondary: #179287; --accent: #d20f39; --input-bg: rgba(255, 255, 255, 0.8); --dim: #6c6f85; --glow: transparent;
  }
  ...
  .feature { color: var(--text); font-weight: 500; }
