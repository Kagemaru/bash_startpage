defmodule BashStartpage.MixProject do
  use Mix.Project
  ...
  defp aliases do
    [
      ...
      test: ["ash_sqlite.migrate --quiet", "test"],
      "assets.setup": ["tailwind.install --if-missing", "esbuild.install --if-missing"],
      "assets.build": ["compile", "tailwind bash_startpage", "esbuild bash_startpage"],
      "assets.deploy": [
        "tailwind bash_startpage --minify",
        "esbuild bash_startpage --minify",
        "phx.digest"
      ],
