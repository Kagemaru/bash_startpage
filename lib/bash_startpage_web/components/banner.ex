defmodule BashStartpageWeb.Components.Banner do
  @moduledoc """
  BashStartpageWeb.Components.Banner module provides components for rendering customizable banners in your **Phoenix LiveView**
  application.
