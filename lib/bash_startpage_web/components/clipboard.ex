defmodule BashStartpageWeb.Components.Clipboard do
  @moduledoc """
  The `BashStartpageWeb.Components.Clipboard` is a Phoenix LiveView component module for creating customizable clipboard functionality.
