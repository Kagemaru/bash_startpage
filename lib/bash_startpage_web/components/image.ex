defmodule BashStartpageWeb.Components.Image do
  @moduledoc """
  The `BashStartpageWeb.Components.Image` module provides a component for rendering images in a Phoenix application.
