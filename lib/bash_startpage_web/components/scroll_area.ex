defmodule BashStartpageWeb.Components.ScrollArea do
  @moduledoc """
  The `BashStartpageWeb.Components.ScrollArea` module provides a customizable scroll area component for Phoenix LiveView
