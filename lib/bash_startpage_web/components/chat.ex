defmodule BashStartpageWeb.Components.Chat do
  @moduledoc """
  `BashStartpageWeb.Components.Chat` is a Phoenix LiveView component module for creating customizable chat interfaces.
