defmodule BashStartpageWeb.Components.Gallery do
  @moduledoc """
  The `BashStartpageWeb.Components.Gallery` module provides a customizable gallery component for displaying
