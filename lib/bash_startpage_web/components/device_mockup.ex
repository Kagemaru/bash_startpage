defmodule BashStartpageWeb.Components.DeviceMockup do
  @moduledoc """
  The `BashStartpageWeb.Components.DeviceMockup` module provides a customizable component for displaying
