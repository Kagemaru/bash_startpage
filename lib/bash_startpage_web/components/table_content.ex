defmodule BashStartpageWeb.Components.TableContent do
  @moduledoc """
  `BashStartpageWeb.Components.TableContent` is a component module designed to create flexible and dynamic
