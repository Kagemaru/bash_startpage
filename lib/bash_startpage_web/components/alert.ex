defmodule BashStartpageWeb.Components.Alert do
  @moduledoc """
  BashStartpageWeb.Components.Alert module provides collection of alert components and helper functions for managing and displaying alerts
