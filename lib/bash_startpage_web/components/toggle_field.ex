defmodule BashStartpageWeb.Components.ToggleField do
  @moduledoc """
  BashStartpageWeb.Components.ToggleField component renders a toggle field with customizable options.
