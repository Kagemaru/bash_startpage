defmodule BashStartpageWeb.Components.Footer do
  @moduledoc """
  The `BashStartpageWeb.Components.Footer` module provides a customizable footer component for Phoenix applications,
