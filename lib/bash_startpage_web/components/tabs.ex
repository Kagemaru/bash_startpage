defmodule BashStartpageWeb.Components.Tabs do
  @moduledoc """
  `BashStartpageWeb.Components.Tabs` is a Phoenix component module that provides a highly customizable tab
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/tabs
  ...
  import BashStartpageWeb.Components.Badge, only: [badge: 1]
