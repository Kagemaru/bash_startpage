defmodule BashStartpageWeb.Components.Stepper do
  @moduledoc """
  The `BashStartpageWeb.Components.Stepper` module provides a flexible and interactive stepper component
  ...
  The `BashStartpageWeb.Components.Stepper` enhances user experience by providing a clear and concise representation
