defmodule BashStartpageWeb.Components.Indicator do
  @moduledoc """
  The `BashStartpageWeb.Components.Indicator` module provides a versatile component for visually highlighting
