defmodule BashStartpageWeb.Components.Menu do
  @moduledoc """
  The `BashStartpageWeb.Components.Menu` module is designed to render a hierarchical menu structure in
  ...
  The `BashStartpageWeb.Components.Menu` is ideal for creating multi-level navigation menus in
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/menu
  ...
  import BashStartpageWeb.Components.Button, only: [button_link: 1]
