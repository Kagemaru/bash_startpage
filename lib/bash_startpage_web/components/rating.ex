defmodule BashStartpageWeb.Components.Rating do
  @moduledoc """
  The `BashStartpageWeb.Components.Rating` module provides a versatile rating component for Phoenix LiveView
