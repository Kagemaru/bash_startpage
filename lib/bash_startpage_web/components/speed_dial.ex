defmodule BashStartpageWeb.Components.SpeedDial do
  @moduledoc """
  The `BashStartpageWeb.Components.SpeedDial` module provides a versatile speed dial component for Phoenix
