defmodule BashStartpageWeb.Components.CheckboxCard do
  @moduledoc """
  The `BashStartpageWeb.Components.CheckboxCard` module provides a customizable checkbox card component for Phoenix LiveView
