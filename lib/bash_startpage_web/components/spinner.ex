defmodule BashStartpageWeb.Components.Spinner do
  @moduledoc """
  The `BashStartpageWeb.Components.Spinner` module provides a dynamic and customizable loading spinner
  ...
  With its flexible design, the `BashStartpageWeb.Components.Spinner` module enables developers to provide
