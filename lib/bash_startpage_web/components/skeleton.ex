defmodule BashStartpageWeb.Components.Skeleton do
  @moduledoc """
  The `BashStartpageWeb.Components.Skeleton` module provides a reusable component for displaying skeleton
