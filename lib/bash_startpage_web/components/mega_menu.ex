defmodule BashStartpageWeb.Components.MegaMenu do
  @moduledoc """
  The `BashStartpageWeb.Components.MegaMenu` module provides a customizable and interactive mega menu component
