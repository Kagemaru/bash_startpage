defmodule BashStartpageWeb.Components.NativeSelect do
  @moduledoc """
  The `BashStartpageWeb.Components.NativeSelect` module provides a customizable native select component
  ...
  With built-in error handling and custom error messages, `BashStartpageWeb.Components.NativeSelect`
