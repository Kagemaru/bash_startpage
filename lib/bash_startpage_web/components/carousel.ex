defmodule BashStartpageWeb.Components.Carousel do
  @moduledoc """
  Provides a versatile and customizable carousel component for the `BashStartpageWeb.Components.Carousel`
  project.
