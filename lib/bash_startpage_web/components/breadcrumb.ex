defmodule BashStartpageWeb.Components.Breadcrumb do
  @moduledoc """
  Provides a flexible and customizable `BashStartpageWeb.Components.Breadcrumb` component for displaying
