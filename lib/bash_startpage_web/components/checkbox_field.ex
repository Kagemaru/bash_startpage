defmodule BashStartpageWeb.Components.CheckboxField do
  @moduledoc """
  BashStartpageWeb.Components.CheckboxField Module Provides a customizable checkbox component for use in Phoenix LiveView forms.
