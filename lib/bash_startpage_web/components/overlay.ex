defmodule BashStartpageWeb.Components.Overlay do
  @moduledoc """
  The `BashStartpageWeb.Components.Overlay` module provides a versatile overlay component for
  ...
  The `BashStartpageWeb.Components.Overlay` is perfect for creating modal backgrounds, loading screens,
