defmodule BashStartpageWeb.Components.Popover do
  @moduledoc """
  The `BashStartpageWeb.Components.Popover` module provides a versatile popover component for Phoenix LiveView
